...
export const APPS = [
  { name: 'Feedly', link: 'https://feedly.com/i/my', icon: faRssSquare},
  { name: 'YNAB', link: 'https://app.youneedabudget.com/70ae8da7-d394-43a9-9fba-90f2107e2fcd/', icon: faDollarSign},
